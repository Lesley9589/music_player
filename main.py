...
def about_us():
    tkinter.messagebox.showinfo('About Music Player', 'This is a music player build using Python Tkinter by Lesley!')
...
root.title("Music Player By Lesley")
root.iconbitmap(r'guitar.ico')
